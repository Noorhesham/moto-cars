  ...
  return (
    <div>
      ...
      <MaxWidthWrapper className="flex flex-col gap-5">
        <h1 className="text-5xl font-bold tracking-tight">OUR MANAGEMENT TEAM</h1>
        <p>
          Our swift progress can be attributed to a <strong>visionary management team</strong> that excels in research
          and innovation. Comprising visionaries, creatives, entrepreneurs, and mobility enthusiasts, our team is
          dedicated to revolutionizing transportation. Their commitment to creating a sustainable lifestyle drives our
          focus on delivering top-quality and high-performance products. By prioritizing sustainability, our team
          ensures that Vmoto remains at the forefront of urban mobility, consistently pushing the boundaries of what's
          possible in electric vehicle technology.
        </p>
      </MaxWidthWrapper>
